...
class ApiHelper {
  ...
  static Future<Response> put(String controller, String id,
    ...
    var url = Uri.parse('${Constanst.apiUrl}$controller$id');
  ...
  static Future<Response> post(
    ...
    var url = Uri.parse('${Constanst.apiUrl}$controller');
  ...
  static Future<Response> getBrands(String token) async {
    var url = Uri.parse('${Constanst.apiUrl}/api/Brands');
    var response = await http.get(
      url,
      headers: {
        'content-type': 'application/json',
  ...
  static Future<Response> getUsers(String token) async {
    var url = Uri.parse('${Constanst.apiUrl}/api/Users');
    var response = await http.get(
      url,
      headers: {
        'content-type': 'application/json',
  ...
  static Future<Response> getDocumentTypes(String token) async {
    var url = Uri.parse('${Constanst.apiUrl}/api/DocumentTypes');
    var response = await http.get(
      url,
      headers: {
        'content-type': 'application/json',
  ...
  static Future<Response> getVehiculeTypes(String token) async {
    var url = Uri.parse('${Constanst.apiUrl}/api/VehiculeTypes');
    var response = await http.get(
      url,
      headers: {
        'content-type': 'application/json',
